        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressContent = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Order_AppUser_BuyerId",
                        column: x => x.BuyerId,
                        principalTable: "AppUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Order_AppUser_SellerId",
                        column: x => x.SellerId,
                        principalTable: "AppUser",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_BookAuthor_Id", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookLanguage = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookForSale", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookForSale_Book_BookId",
                        column: x => x.BookId,
                        principalTable: "Book",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookForSale_AppUser_SellerId",
                        column: x => x.SellerId,
                        principalTable: "AppUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalPaymentPrice = table.Column<double>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    BuyerId = table.Column<string>(nullable: false),
                    BookForSaleId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShoppingCart_BookForSale_BookForSaleId",
                        column: x => x.BookForSaleId,
                        principalTable: "BookForSale",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShoppingCart_AppUser_BuyerId",
                        column: x => x.BuyerId,
                        principalTable: "AppUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderDetail_ShoppingCart_ShoppingCartId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookForSale_BookId",
                table: "BookForSale",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_BookForSale_SellerId",
                table: "BookForSale",
                column: "SellerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetail_ShoppingCartId",
                table: "OrderDetail",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCart_BookForSaleId",
                table: "ShoppingCart",
